  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-950 transition-colors duration-200">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-16 text-center">
        ...
        <p className="mt-4 text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
          {t("landing.subtitle")}
        </p>

        <div className="flex flex-col sm:flex-row gap-4 mb-10 w-full max-w-4xl mx-auto px-4 justify-center">
          <div className="flex items-center gap-4 bg-purple-50 dark:bg-gray-800/50 p-4 rounded-2xl border border-purple-100 dark:border-gray-700 w-full sm:w-1/3 shadow-sm">
            <div className="bg-purple-100 dark:bg-purple-900/40 w-12 h-12 rounded-full flex items-center justify-center shrink-0">
              <Users className="w-6 h-6 text-purple-600 dark:text-purple-400" />
            </div>
            <span className="font-bold text-gray-900 dark:text-gray-100 text-left leading-tight text-lg">
              Creá Torneos
              <br className="hidden sm:block" /> Privados
            </span>
          </div>
          <div className="flex items-center gap-4 bg-green-50 dark:bg-gray-800/50 p-4 rounded-2xl border border-green-100 dark:border-gray-700 w-full sm:w-1/3 shadow-sm">
            <div className="bg-green-100 dark:bg-green-900/40 w-12 h-12 rounded-full flex items-center justify-center shrink-0">
              <Swords className="w-6 h-6 text-green-600 dark:text-green-400" />
            </div>
            <span className="font-bold text-gray-900 dark:text-gray-100 text-left leading-tight text-lg">
              Desafiá
              <br className="hidden sm:block" /> 1v1
            </span>
          </div>
          <div className="flex items-center gap-4 bg-orange-50 dark:bg-gray-800/50 p-4 rounded-2xl border border-orange-100 dark:border-gray-700 w-full sm:w-1/3 shadow-sm">
            <div className="bg-orange-100 dark:bg-orange-900/40 w-12 h-12 rounded-full flex items-center justify-center shrink-0">
              <Trophy className="w-6 h-6 text-orange-600 dark:text-orange-400" />
            </div>
            <span className="font-bold text-gray-900 dark:text-gray-100 text-left leading-tight text-lg">
              Ganá
              <br className="hidden sm:block" /> Medallas
            </span>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-900 py-20 border-y border-gray-100 dark:border-gray-800 transition-colors duration-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="bg-orange-50 dark:bg-gray-800/50 p-8 rounded-2xl border border-orange-100 dark:border-gray-700 text-center">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20 text-center">
        ...
        >
          {t("landing.playNow", "¡Empezá a jugar ahora!")}{" "}
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 dark:border-gray-800 text-sm text-gray-500 dark:text-gray-200 flex flex-col items-center gap-2">
          <div className="flex flex-col sm:flex-row gap-4 mb-2">
            ...
            >
              {t("terms.privacy", "Política de Privacidad")}
            </a>

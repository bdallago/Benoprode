import { Trophy, Users, PenSquare, ArrowRight, Globe, Lock, CheckCircle2, Swords } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-950 transition-colors duration-200">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-16 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10 w-full max-w-4xl mx-auto px-4">
          <div className="flex flex-col items-center gap-3 bg-purple-50 dark:bg-gray-800/50 py-5 px-4 rounded-2xl shadow-sm border border-purple-100 dark:border-gray-700 text-center">
            <div className="bg-purple-100 dark:bg-purple-900/40 p-3 rounded-full">
              <Lock className="w-6 h-6 text-purple-600 dark:text-purple-400" />
            </div>
            <span className="font-bold text-gray-900 dark:text-gray-100 text-lg md:text-base lg:text-lg">Creá Torneos Privados</span>
          </div>
          <div className="flex flex-col items-center gap-3 bg-red-50 dark:bg-gray-800/50 py-5 px-4 rounded-2xl shadow-sm border border-red-100 dark:border-gray-700 text-center">
            <div className="bg-red-100 dark:bg-red-900/40 p-3 rounded-full">
              <Swords className="w-6 h-6 text-red-600 dark:text-red-400" />
            </div>
            <span className="font-bold text-gray-900 dark:text-gray-100 text-lg md:text-base lg:text-lg">Desafiá 1v1</span>
          </div>
          <div className="flex flex-col items-center gap-3 bg-orange-50 dark:bg-gray-800/50 py-5 px-4 rounded-2xl shadow-sm border border-orange-100 dark:border-gray-700 text-center">
            <div className="bg-orange-100 dark:bg-orange-900/40 p-3 rounded-full">
              <Trophy className="w-6 h-6 text-orange-600 dark:text-orange-400" />
            </div>
            <span className="font-bold text-gray-900 dark:text-gray-100 text-lg md:text-base lg:text-lg">Ganá Medallas</span>
          </div>
        </div>

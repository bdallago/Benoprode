export function renderFirstDate(displayName: string): string {
  return `<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>¿Cómo te fue en la primera fecha?</title>
</head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="font-size:16px;color:#94a3b8;line-height:1.7;margin:0 0 16px;">
                Ya terminó la primera fecha del Mundial y los puntos empezaron a moverse.
              </p>
              <p style="font-size:15px;color:#94a3b8;line-height:1.7;margin:0 0 32px;">
                Entrá a ver cómo quedaste en la tabla, cuántos puntos sumaste y cómo están tus amigos en la liga.
              </p>
              ...
              <p style="font-size:15px;color:#94a3b8;margin:0;">¡Todavía queda mucho Mundial por delante!</p>
            </td>
          </tr>
          <tr>

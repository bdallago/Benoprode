export function renderDayBefore(displayName: string): string {
  return `<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Mañana arranca el Mundial</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#1e293b;border-radius:16px;overflow:hidden;border:1px solid #334155;">
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="font-size:16px;color:#e2e8f0;font-weight:700;line-height:1.7;margin:0 0 16px;">
                Mañana a las 18hs arranca el Mundial y hoy se cierra la posibilidad de modificar tus predicciones.
              </p>
              <p style="font-size:15px;color:#94a3b8;line-height:1.7;margin:0 0 32px;">
                Si todavía no fijaste tu prode, este es el momento. Después del pitido inicial, lo que dijiste es lo que vale.
              </p>
              <table cellpadding="0" cellspacing="0" style="margin:0 auto 32px;">
                <tr>
                  <td style="background:linear-gradient(135deg,#dc2626,#b91c1c);border-radius:10px;">
              ...
              <p style="font-size:15px;color:#94a3b8;margin:0;">¡Mañana empieza la fiesta!</p>
            </td>
          </tr>
          <tr>

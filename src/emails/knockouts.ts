export function renderKnockouts(displayName: string): string {
  return `<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Arranca lo bueno</title>
</head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="font-size:16px;color:#94a3b8;line-height:1.7;margin:0 0 16px;">
                La fase de grupos terminó y ya sabemos quiénes siguen en carrera. ¿Acertaste los clasificados?
              </p>
              <p style="font-size:15px;color:#94a3b8;line-height:1.7;margin:0 0 32px;">
                Ahora empieza la eliminatoria directa, donde cada partido define todo. Entrá a ver cómo quedaste parado y cómo están tus rivales en la liga.
              </p>
              ...
              <p style="font-size:15px;color:#94a3b8;margin:0;">¡A aguantar las eliminatorias!</p>
            </td>
          </tr>
          <tr>
